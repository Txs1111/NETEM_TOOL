...
<body>
<% List<Lead_User> aims = (List<Lead_User>) request.getAttribute("aims"); %>
	<!-- 右边内容 -->
		...
		<ul class="sidebar-menu">
			...
			<li class="treeview" id="li_active">
				...
				<ul class="treeview-menu" id="open">
					<li><a href="AimController" class="green_font"><i class="fa fa-dot-circle-o" aria-hidden="true"></i>
						考研目的</a></li>
