			...
			<div class="re_typeQ">
				<ul>
					...
					<li class="re_typeSum">
						...
						<span class="re_load">立即下载</span>
						<span class="re_loadImg">
							<img src="img/info_img/re_loadImg.png" >
						</span>
					</li>
					<li class="re_typeSum">
						<span class="re_type">大纲汇总【电子版】</span>
						<span class="re_load">立即下载</span>
					</li>
				</ul>
			</div>
			<div class="re_footer">
				<div class="re_loadAll">下载全部</div>
			</div>			
		</div>	
	</div>
