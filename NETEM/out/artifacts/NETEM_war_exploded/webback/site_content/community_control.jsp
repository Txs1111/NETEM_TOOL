...
<body>
<% List<Community> communitys = (List<Community>) request.getAttribute("communitys"); %>
	<!-- 右边内容 -->
		...
		<ul class="sidebar-menu">
			...
			<li class="treeview" id="li_active">
				...
				<ul class="treeview-menu" id="open">
					...
					<li><a href="CommunityController" class="green_font"><i class="fa fa-dot-circle-o"
																			aria-hidden="true"></i> 社区交流</a></li>
