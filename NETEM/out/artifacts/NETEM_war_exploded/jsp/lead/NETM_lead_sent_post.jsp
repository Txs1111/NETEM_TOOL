	...
	<body>
		<div style="width: 100%;" id="main_block">
			...
			<div class="post_content">
				...
				<div class="content_inf" style="margin-top: 15px;">
					<textarea name="content" type="text" placeholder="请输入内容"  style=""></textarea>
				</div>
				
				<div class="bottom_block" onclick="postContent()">
					<button>发送</button>
				</div>
			</div>
		</div>
...
<script>
	function postContent() {
		...
		let type='';
		let content='';
		let URL='${pageContext.request.contextPath}/NETEM/AddLeadSuccess';
		$.ajax({
			type:'post',
			url:URL,
			data:{userId:'',type:1,content:'ajax'},
