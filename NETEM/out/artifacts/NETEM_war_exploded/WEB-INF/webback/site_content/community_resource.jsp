...
<body>
<% List<Community> resources = (List<Community>) request.getAttribute("resources"); %>
	<!-- 右边内容 -->
		...
		<ul class="sidebar-menu">
			...
			<li class="treeview" id="li_active">
				...
				<ul class="treeview-menu" id="open">
					...
					<li><a href="CommunityResource" class="green_font"><i class="fa fa-dot-circle-o"
																		  aria-hidden="true"></i> 社区资源</a></li>
