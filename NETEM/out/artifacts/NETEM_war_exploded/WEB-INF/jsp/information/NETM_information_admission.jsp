		...
		<div style="width: 100%;height: 700px;" id="main_block">
			...
			<div class="big-container">
				...
				<div class="container-head">
					<a href="NETM_information_searchPage">
			...
			<div class="real_content">
				<ul>
					<%if (admission!=null) for (Information a:admission){%>
					<li class="twenty">
						<a href="${pageContext.request.contextPath}/NETEM/admissionDetail/<%=a.getID()%>">
							<span class="iconfont icon-shijuan yellow_ifont">&#xe604;</span>
							<span class="wenzi"><%=a.getTitle()%></span>
