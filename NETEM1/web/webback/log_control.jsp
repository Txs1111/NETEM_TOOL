<%@ page import="com.NETEM.pojo.Log" %>
	...
	<div class="main_block">
		...
		<div class="panel">
			...
			<div class="panel-body">
				...
				<label>
					访问者:<input type="text" class="form-control"/>
				</label>
				<label>
					访问人ID:<input type="text" class="form-control"/>
				</label>
				<label>
					访问模块:<input type="text" class="form-control"/>
				</label>
				<label>
					访问内容:<input type="text" class="form-control"/>
				</label>
				<label>
					起始访问时间:<input type="text" class="form-control"/>
				</label>
				<label>
					结束访问时间:<input type="text" class="form-control"/>
				</label>
				<button type="button" class="btn btn-primary green_style" onclick="searchLogs()">
		...
		<table class="table table-hover table-bordered">
			...
			<script>
				function searchLogs(){
					...
					let addTime='';
					let consumeTime='';
					let URL = "${pageContext.request.contextPath}/BackNETEM/SearchLogs"
					$.ajax({
						type:"post",
						url:URL,
						data: {
...
<aside class="main-sidebar">
	<section class="sidebar">
		<ul class="sidebar-menu">
			...
			<li id="li_active">
				<a href="LogController" class="point_a">
