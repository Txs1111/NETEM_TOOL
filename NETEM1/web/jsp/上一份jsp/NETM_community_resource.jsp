	...
	<body>
		<div style="width: 100%;" id="main_block"> 
			...
			<div class="yard_block stable">
				<div class="section_tab_active"><b>资源</b></div>
				<div class="section_tab">
					<a href="NETM_community_QA.html">问答</a>
				</div>
				<div class="section_tab">
					<a href="NETM_communication.html">社区</a>
				</div>
			...
			<div style="height: 700px;overflow-y: scroll;">
				<div class="resource_block">
					<div class="resource_left_img">
						<div class="resource_img_block">
							<img src="img/example_img/2.jpeg" class="pimg"/>
						</div>
					</div>
					<div class="resource_right_text">
						<div class="resource_tittle">
							炉石传说佛祖骑起手留牌技巧
						</div>
						<div class="resource_inf">
							对于炉石传说佛祖骑来说 重要的牌无疑就是神秘挑战者这种牌，留着嘛~觉得卡手还没6费就被打崩，不留嘛又老是抓不到，前期好不容易积累的优势，对手中期
						</div>
						<div class="resource_date_comment">
							...
							<div class="date">
								...
								<div>
									<img src="img/icon_img/like.png" width="13px" height="13px" />
									:17
								</div>
								<div>&nbsp;&nbsp;2021-6-9&nbsp;&nbsp;&nbsp;&nbsp;</div>
								</div>
					...
					<div class="resource_text">
						...
						<div class="resource_date_comment">
							...
							<div class="date">
								<div style="display: flex;justify-content: space-between;">
								<div>
									<img src="img/icon_img/like.png" width="13px" height="13px" style="margin-top: 2px;"/>
									:17
								</div>
								<div>&nbsp;&nbsp;2021-6-9&nbsp;&nbsp;&nbsp;&nbsp;</div>
								</div>
