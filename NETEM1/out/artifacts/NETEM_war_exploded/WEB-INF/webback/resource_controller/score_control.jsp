...
<body>
<% List<Information> scores = (List<Information>) request.getAttribute("scores"); %>
	<!-- 右边内容 -->
	<div class="main_block">
		...
		<div class="panel">
			...
			<div class="panel-body">
				...
				<button type="button" class="btn btn-primary green_style" onclick="searchScores()">
					<i class="fa fa-search"></i> &nbsp;搜索&nbsp;
				</button>
				<button type="button" class="btn btn-primary blue_style add"  data-popup-target="addPopup" onclick="addScore()">
		...
		<table class="table table-hover table-bordered">
			...
			<% for (Information s : scores) {%>
				<tr>
					...
					<td><%=s.getAddTime()%>
					<td>
						<button class="change" data-popup-target="demoPopup" onclick="updateScore()"><i class="fa fa-dedent"></i>&nbsp;&nbsp;修改</button>
						<button class="delete" data-popup-target="deletePopup" onclick="delScore()"><i class="fa fa-close"></i>&nbsp;&nbsp;删除</button>
					</td>
				</tr>
				<%}%>
			</tbody>
			...
			<script>
				function searchScores(){
					...
					let content='';
					let time='';
					let URL = "${pageContext.request.contextPath}/BackNETEM/SearchScores"
					$.ajax({
						type:"post",
						url:URL,
				...
				function addScore(){
					...
					let time='';
					let image='';
					let URL = "${pageContext.request.contextPath}/BackNETEM/AddScore"
					$.ajax({
						type:"post",
						url:URL,
				...
				function updateScore(){
					...
					let content='';
					let image='';
					let URL = "${pageContext.request.contextPath}/BackNETEM/UpdateScore"
					$.ajax({
						type:"post",
						url:URL,
						data:{id: 4, title: 'ajax', content: 'ajax', image: 'ajax'},
						success:function (data){
							alert('success'+data)
						},error:function (){
							alert('error')
		...
		<ul class="sidebar-menu">
			...
			<li class="treeview" id="li_active">
				...
				<ul class="treeview-menu" id="open">
					...
					<li><a href="ScoreController" class="green_font"><i class="fa fa-dot-circle-o"
																		aria-hidden="true"></i> 历年分数</a></li>
