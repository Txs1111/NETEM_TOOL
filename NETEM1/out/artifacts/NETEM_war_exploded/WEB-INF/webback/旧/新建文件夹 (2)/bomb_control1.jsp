...
<body>
<% List<Lead_User> bombs = (List<Lead_User>) request.getAttribute("bombs"); %>
<!-- 右边内容 -->
        ...
        <ul class="sidebar-menu">
            ...
            <li class="treeview" id="li_active">
                ...
                <ul class="treeview-menu" id="open">
                    ...
                    <li><a href="BombController" class="green_font"><i class="fa fa-dot-circle-o"
                                                                       aria-hidden="true"></i> 考研雷区</a></li>
