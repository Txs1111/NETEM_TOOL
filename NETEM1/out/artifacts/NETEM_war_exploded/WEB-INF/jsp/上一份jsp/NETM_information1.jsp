	...
	<div style="width: 100%;height: 700px;" id="main_block">
		...
		<div class="big-container">
			...
			<nav id="operbox">
				<div class="nav_part">
					<a href="rankDetails">
						<img src="img/info_img/rank.png">
						<span>院校排名</span>
					</a>
					<a href="markDetails">
						<img src="img/info_img/mark.png" >
						<span>历年分数</span>
					</a>
					<a href="real_examDetails">
						<img src="img/info_img/real.png" >
						<span>历年真题</span>
					</a>
					<a href="outlineDetails">
						<img src="img/info_img/outline.png" >
						<span>考试大纲</span>
					</a>
					<a href="admissionDetails">
						<img src="img/info_img/admission.png" >
						<span>报录情况</span>
					</a>
					<a href="teacherDetails">
						<img src="img/info_img/teacher.png" >
						<span>优秀老师</span>
					</a>
				</div>
			</nav>
			...
			<div class="small-container">
				<ul>
				    ...
				    <li class="lili rank_ul_li">
						<div class="level">
							<span class="iconfont icon-paper" style="float: left;padding-left: 2%;">&#xe604;</span>
							<span class="small-left">院校排名</span>
							<a href="rankDetails" class="lilili">
								<img src="img/info_img/more.png" >
							</a>
						</div>
						<ul class="ululul">
                            <% if (Rank != null) for(int i =0;i<Rank.size();i++){%>
							<li><a href="#"><%=Rank.get(i).getTitle()%></a></li><%}%>
						</ul>
				    </li>
					...
					<li class="lili mark_ul_li" style="padding-top: 3%;">
						<span class="iconfont icon-paper" style="font-weight: 600;float: left;padding-left: 2%;">&#xe61a;</span>
						...
						<ul class="ululul" style="text-align: center;">
                            ...
                            <li><a href="#"><%=Mark.get(i).getTitle()%></a></li><%}%>
						</ul>
					</li>
					...
					<li class="lili real_ul_li">
						...
						<ul class="ululul real_ul">
                            ...
                            <li><a href="#"><%=realExam.get(i).getTitle()%></a></li><%}%>
						</ul>
					</li>
...
<%--                        <%}%>--%>
                        <% if (outline != null){%>
                            ...
                            <a href="outlineDetails" class="outline_b">
					...
					<li class="lili admission_ul_li">
						...
						<ul class="ululul">
                            ...
                            <li><a href="#"><%=Admission.get(i).getTitle()%></a></li><%}%>
						</ul>
					</li>
