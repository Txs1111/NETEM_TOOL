	...
	<% List<Outline> outline = (List<Outline>) request.getAttribute("outline");%>
		<div style="width: 100%;" id="main_block">
			...
			<div class="real_content">
				<ul>
					...
					<li class="twenty">
						<a href="${pageContext.request.contextPath}/NETEM/outlineDetail/<%=o.getID()%>">
							<span class="iconfont icon-shijuan blue_ifont">&#xe63f;</span>
							<span class="wenzi"><%=o.getTitle()%></span>
		...
		<div class="nav-bottom">
			<ul class="local-nav">
				...
				<li>
					<a href="${pageContext.request.contextPath}/NETEM/communication">
						<span class="local-nav-icon">
