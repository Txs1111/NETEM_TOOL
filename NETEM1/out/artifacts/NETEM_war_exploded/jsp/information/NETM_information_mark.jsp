...
<div style="width: 100%;" id="main_block">
    ...
    <div class="real_content">
        <ul>
            <%if (mark != null) for (Information m : mark) {%>
            <li class="twenty">
                <a href="${pageContext.request.contextPath}/NETEM/markDetail/<%=m.getID()%>">
                    <span class="iconfont icon-shijuan blue_ifont">&#xe69f;</span>
                    <span class="wenzi"><%=m.getTitle()%></span>
                </a>
